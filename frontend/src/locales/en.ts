export const en = {
  app: {
    ...
    newGame: {
      ...
      targetLabel: "Play to",
      targetEndless: "Endless",
      targetRounds: "A number of rounds",
      targetPoints: "A points total",
      targetEndlessHint: "Keep playing round after round — finish the game whenever you like.",
      targetValueRounds: "Rounds",
      targetValuePoints: "Target points",
      players: "Players",
      playersHint: "Add yourself, then invite players or add guests. You need 2 to start scoring.",
      needOne: "Add at least yourself.",
      addMe: "Add me",
      addGuest: "Add guest",
